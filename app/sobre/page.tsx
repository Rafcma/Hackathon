    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto py-8 px-4">
        <div className="bg-[#efece3] rounded-lg shadow-sm p-8 max-w-4xl mx-auto">
          <h1 className="text-2xl font-bold text-gray-800 mb-6 font-cinzel">Sobre o Sistema</h1>
          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              <p className="text-lg text-gray-700 mb-4">
                ...
                inteligência artificial e análise de dados, nosso sistema oferece uma solução eficaz para um dos maiores
                desafios enfrentados pelas instituições educacionais.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Este projeto foi desenvolvido como parte do Hackathon Unifenas 2025, com o objetivo de criar uma solução
                tecnológica para reduzir as taxas de evasão escolar. Nossa equipe multidisciplinar combinou
                conhecimentos em desenvolvimento de software, ciência de dados e pedagogia para criar uma ferramenta que
                não apenas identifica alunos em risco, mas também sugere intervenções personalizadas.
              </p>

              <p className="text-gray-700 mb-4">
                A solução foi construída utilizando tecnologias modernas como Next.js, React e TailwindCSS para o
                frontend, garantindo uma interface intuitiva e responsiva. Para o backend, implementamos uma integração
                com a API da Unifenas, que fornece dados em tempo real sobre a atividade dos alunos no ambiente virtual
                de aprendizagem.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                relacionados ao desempenho e engajamento dos alunos. O modelo de predição atribui pesos diferentes a
                cada fator, calculando um score de engajamento que determina o nível de risco de evasão.
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-4 font-cinzel">Integração com Dados Reais</h2>
              <p className="text-gray-700 mb-4">
